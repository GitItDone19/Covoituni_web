...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Admin\\AnnonceEventController' => 'getAnnonceEventControllerService',
            ...
            'App\\Controller\\ConducteurController' => 'getConducteurControllerService',
            ...
            'App\\Controller\\PassagerController' => 'getPassagerControllerService',
            'App\\Controller\\PriceController' => 'getPriceControllerService',
            'App\\Controller\\ReclamationController' => 'getReclamationController2Service',
            'App\\Controller\\RideController' => 'getRideControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('KoRJW4LFxU', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.easyadmin'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EtpsV8dGWe', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.security_is_csrf_token_valid_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0mTY5RgQOO', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pDvVnk7wca', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KW7NM6YsJe', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YT03nqSljs', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('Symfony\\Component\\Mailer\\Event\\MessageEvent', [#[\Closure(name: 'App\\EventSubscriber\\EmailSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\EmailSubscriber'] ??= new \App\EventSubscriber\EmailSubscriber()), 'onMessage'], 0);
        $instance->addListener('Symfony\\Component\\Mailer\\Event\\FailedMessageEvent', [#[\Closure(name: 'App\\EventSubscriber\\EmailSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\EmailSubscriber'] ??= new \App\EventSubscriber\EmailSubscriber()), 'onFailedMessage'], 0);
        $instance->addListener('kernel.controller', [#[\Closure(name: 'App\\EventSubscriber\\TwigEventSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\TwigEventSubscriber'] ?? self::getTwigEventSubscriberService($container)), 'onKernelController'], 0);
    ...
    /**
     * Gets the private 'App\EventSubscriber\TwigEventSubscriber' shared autowired service.
     *
     * @return \App\EventSubscriber\TwigEventSubscriber
     */
    protected static function getTwigEventSubscriberService($container)
    {
        $a = ($container->privates['twig'] ?? self::getTwigService($container));

        if (isset($container->privates['App\\EventSubscriber\\TwigEventSubscriber'])) {
            return $container->privates['App\\EventSubscriber\\TwigEventSubscriber'];
        }
        ...
        return $container->privates['App\\EventSubscriber\\TwigEventSubscriber'] = new \App\EventSubscriber\TwigEventSubscriber($a, $b);
    }
    ...
    protected static function getEntityFactoryService($container)
    {
        ...
        return $container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Factory\\EntityFactory'] = new \EasyCorp\Bundle\EasyAdminBundle\Factory\EntityFactory(new \EasyCorp\Bundle\EasyAdminBundle\Factory\FieldFactory($b, $c, new RewindableGenerator(function () use ($container) {
            ...
            yield 12 => ($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Field\\Configurator\\ImageConfigurator'] ??= new \EasyCorp\Bundle\EasyAdminBundle\Field\Configurator\ImageConfigurator('D:\\Covoituni_web-master'));
    ...
    {
        return $container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminRouteGenerator'] = new \EasyCorp\Bundle\EasyAdminBundle\Router\AdminRouteGenerator(new RewindableGenerator(fn () => new \EmptyIterator(), 0), new RewindableGenerator(fn () => new \EmptyIterator(), 0), ($container->services['cache.easyadmin'] ?? self::getCache_EasyadminService($container)), ($container->privates['filesystem'] ??= new \Symfony\Component\Filesystem\Filesystem()), $container->targetDir.'', 'en');
    }
    ...
    protected static function getAssetMapperService($container)
    {
        ...
        }, 4), #[\Closure(name: 'asset_mapper', class: 'Symfony\\Component\\AssetMapper\\AssetMapper')] fn () => ($container->privates['asset_mapper'] ?? self::getAssetMapperService($container))), 'D:\\Covoituni_web-master/assets/vendor'), ($container->targetDir.''.'/asset_mapper'), true), ($container->privates['asset_mapper.compiled_asset_mapper_config_reader'] ??= new \Symfony\Component\AssetMapper\CompiledAssetMapperConfigReader('D:\\Covoituni_web-master/public/assets')));
    }
    ...
    {
        return $container->privates['asset_mapper.importmap.config_reader'] = new \Symfony\Component\AssetMapper\ImportMap\ImportMapConfigReader('D:\\Covoituni_web-master/importmap.php', ($container->privates['asset_mapper.importmap.remote_package_storage'] ??= new \Symfony\Component\AssetMapper\ImportMap\RemotePackageStorage('D:\\Covoituni_web-master/assets/vendor')));
    }
    ...
    {
        return $container->privates['asset_mapper.importmap.generator'] = new \Symfony\Component\AssetMapper\ImportMap\ImportMapGenerator(($container->privates['asset_mapper'] ?? self::getAssetMapperService($container)), ($container->privates['asset_mapper.compiled_asset_mapper_config_reader'] ??= new \Symfony\Component\AssetMapper\CompiledAssetMapperConfigReader('D:\\Covoituni_web-master/public/assets')), ($container->privates['asset_mapper.importmap.config_reader'] ?? self::getAssetMapper_Importmap_ConfigReaderService($container)));
    }
    ...
    {
        return $container->privates['asset_mapper.repository'] = new \Symfony\Component\AssetMapper\AssetMapperRepository(['D:\\Covoituni_web-master\\vendor\\symfony\\ux-turbo\\src\\DependencyInjection/../../assets/dist' => '@symfony/ux-turbo', 'D:\\Covoituni_web-master\\vendor\\symfony\\stimulus-bundle\\src\\DependencyInjection/../../assets/dist' => '@symfony/stimulus-bundle', 'assets/' => '', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/public' => 'bundles/easyadmin'], 'D:\\Covoituni_web-master', ['#^(?=[^\\.]).*\\.d\\.ts$#', '#^(?=[^\\.]).*.*/(?=[^\\.])controllers\\.json$#'], true, true);
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('++luSrN02q', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('7qAOZPCloa', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('b7ugczfMPZ', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LnP+Zbudxx', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_token_verifier'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ndVhp9eamD', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('b+8fV0JGMc', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.ux.twig_component'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1koHcw53KO', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hMgnpTSz16', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDebug_ControllerResolverService($container)
    {
        ...
        $a->allowControllers(['App\\Kernel', 'App\\Controller\\AdminController', 'App\\Controller\\Admin\\AnnonceController', 'App\\Controller\\Admin\\AnnonceEventController', 'App\\Controller\\Admin\\CategoryController', 'App\\Controller\\Admin\\ReclamationController', 'App\\Controller\\Admin\\ReservationController', 'App\\Controller\\Admin\\TrajetController', 'App\\Controller\\AvisController', 'App\\Controller\\ChatController', 'App\\Controller\\ConducteurController', 'App\\Controller\\EventController', 'App\\Controller\\HomeController', 'App\\Controller\\MapController', 'App\\Controller\\PassagerController', 'App\\Controller\\PriceController', 'App\\Controller\\ReclamationController', 'App\\Controller\\RideController', 'App\\Controller\\RoleController', 'App\\Controller\\SecurityController', 'App\\Controller\\UserController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['debug.file_link_formatter'] = new \Symfony\Component\ErrorHandler\ErrorRenderer\FileLinkFormatter($container->getEnv('default::SYMFONY_IDE'), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), 'D:\\Covoituni_web-master', #[\Closure(name: 'debug.file_link_formatter.url_format', class: 'string')] fn () => ($container->privates['debug.file_link_formatter.url_format'] ?? $container->load('getDebug_FileLinkFormatter_UrlFormatService')));
    }
    ...
    protected static function getDebug_SerializerService($container)
    {
        ...
        return $container->privates['debug.serializer'] = new \Symfony\Component\Serializer\Debug\TraceableSerializer(new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($a), $b, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer(), $b, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, translator: $c), $b, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), $b, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), $b, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $e), $b, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($d, $e, $f, $g, NULL, [])), $b, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), $b, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), $b, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), $b, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), $b, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($container->privates['mime_types'] ?? self::getMimeTypesService($container))), $b, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\TranslatableNormalizer($c), $b, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), $b, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), $b, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($d, $e, $a, $f, $g, NULL, [], $f), $b, 'default')], [new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\XmlEncoder(), $b, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\JsonEncoder(NULL, NULL), $b, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL), $b, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\CsvEncoder(), $b, 'default')], []), $b, 'default');
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $a->addDriver(($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver(['D:\\Covoituni_web-master\\src\\Entity'], true)), 'App\\Entity');
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\AnnonceEventRepository' => ['privates', 'App\\Repository\\AnnonceEventRepository', 'getAnnonceEventRepositoryService', true],
            ...
            'App\\Repository\\EventParticipationRepository' => ['privates', 'App\\Repository\\EventParticipationRepository', 'getEventParticipationRepositoryService', true],
            ...
            'App\\Repository\\AnnonceEventRepository' => '?',
            ...
            'App\\Repository\\EventParticipationRepository' => '?',
    ...
    {
        $container->privates['doctrine.orm.default_xml_metadata_driver'] = $instance = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(['D:\\Covoituni_web-master\\vendor\\vich\\uploader-bundle\\config\\doctrine' => 'Vich\\UploaderBundle\\Entity'], '.orm.xml', true);
    ...
    {
        return $container->privates['router_listener'] = new \Symfony\Component\HttpKernel\EventListener\RouterListener(($container->services['router'] ?? self::getRouterService($container)), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), ($container->privates['router.request_context'] ?? self::getRouter_RequestContextService($container)), ($container->privates['monolog.logger.request'] ?? self::getMonolog_Logger_RequestService($container)), 'D:\\Covoituni_web-master', true);
    }
    ...
    protected static function getTranslator_DefaultService($container)
    {
        ...
        ]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\IdentityTranslator()), 'en', ['translation.loader.php' => ['php'], 'translation.loader.yml' => ['yaml', 'yml'], 'translation.loader.xliff' => ['xlf', 'xliff'], 'translation.loader.po' => ['po'], 'translation.loader.mo' => ['mo'], 'translation.loader.qt' => ['ts'], 'translation.loader.csv' => ['csv'], 'translation.loader.res' => ['res'], 'translation.loader.dat' => ['dat'], 'translation.loader.ini' => ['ini'], 'translation.loader.json' => ['json']], ['cache_dir' => ($container->targetDir.''.'/translations'), 'debug' => true, 'resource_files' => ['af' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.af.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.af.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.af.xlf'], 'ar' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.ar.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.ar.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.ar.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.ar.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.ar.xliff', 'D:\\Covoituni_web-master\\vendor\\vich\\uploader-bundle/translations\\messages.ar.yaml'], 'az' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.az.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.az.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.az.xlf'], 'be' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.be.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.be.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.be.xlf'], 'bg' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.bg.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.bg.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.bg.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.bg.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.bg.xliff', 'D:\\Covoituni_web-master\\vendor\\vich\\uploader-bundle/translations\\messages.bg.yaml'], 'bs' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.bs.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.bs.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.bs.xlf'], 'ca' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.ca.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.ca.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.ca.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.ca.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.ca.xliff', 'D:\\Covoituni_web-master\\vendor\\vich\\uploader-bundle/translations\\messages.ca.yaml'], 'cs' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.cs.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.cs.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.cs.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.cs.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.cs.xliff', 'D:\\Covoituni_web-master\\vendor\\vich\\uploader-bundle/translations\\messages.cs.yaml'], 'cy' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.cy.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.cy.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.cy.xlf'], 'da' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.da.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.da.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.da.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.da.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.da.xliff'], 'de' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.de.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.de.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.de.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.de.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.de.xliff', 'D:\\Covoituni_web-master\\vendor\\vich\\uploader-bundle/translations\\messages.de.yaml'], 'el' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.el.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.el.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.el.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.el.php'], 'en' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.en.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.en.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.en.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.en.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.en.xliff', 'D:\\Covoituni_web-master\\vendor\\vich\\uploader-bundle/translations\\messages.en.yaml'], 'es' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.es.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.es.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.es.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.es.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.es.xliff', 'D:\\Covoituni_web-master\\vendor\\vich\\uploader-bundle/translations\\messages.es.yaml'], 'et' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.et.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.et.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.et.xlf'], 'eu' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.eu.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.eu.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.eu.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.eu.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.eu.xliff'], 'fa' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.fa.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.fa.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.fa.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.fa.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.fa.xliff'], 'fi' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.fi.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.fi.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.fi.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.fi.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.fi.xliff', 'D:\\Covoituni_web-master\\vendor\\vich\\uploader-bundle/translations\\messages.fi.yaml'], 'fr' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.fr.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.fr.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.fr.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.fr.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.fr.xliff', 'D:\\Covoituni_web-master\\vendor\\vich\\uploader-bundle/translations\\messages.fr.yaml'], 'gl' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.gl.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.gl.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.gl.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.gl.php'], 'he' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.he.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.he.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.he.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.he.php'], 'hr' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.hr.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.hr.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.hr.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.hr.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.hr.xliff'], 'hu' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.hu.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.hu.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.hu.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.hu.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.hu.xliff', 'D:\\Covoituni_web-master\\vendor\\vich\\uploader-bundle/translations\\messages.hu.yaml'], 'hy' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.hy.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.hy.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.hy.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.hy.php'], 'id' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.id.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.id.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.id.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.id.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.id.xliff'], 'it' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.it.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.it.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.it.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.it.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.it.xliff', 'D:\\Covoituni_web-master\\vendor\\vich\\uploader-bundle/translations\\messages.it.yaml'], 'ja' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.ja.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.ja.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.ja.xlf', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.ja.xliff'], 'lb' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.lb.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.lb.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.lb.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.lb.php'], 'lt' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.lt.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.lt.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.lt.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.lt.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.lt.xliff', 'D:\\Covoituni_web-master\\vendor\\vich\\uploader-bundle/translations\\messages.lt.yaml'], 'lv' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.lv.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.lv.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.lv.xlf'], 'mk' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.mk.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.mk.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.mk.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.mk.php'], 'mn' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.mn.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.mn.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.mn.xlf'], 'my' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.my.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.my.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.my.xlf'], 'nb' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.nb.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.nb.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.nb.xlf'], 'nl' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.nl.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.nl.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.nl.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.nl.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.nl.xliff', 'D:\\Covoituni_web-master\\vendor\\vich\\uploader-bundle/translations\\messages.nl.yaml'], 'nn' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.nn.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.nn.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.nn.xlf'], 'no' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.no.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.no.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.no.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.no.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.no.xliff'], 'pl' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.pl.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.pl.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.pl.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.pl.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.pl.xliff', 'D:\\Covoituni_web-master\\vendor\\vich\\uploader-bundle/translations\\messages.pl.yaml'], 'pt' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.pt.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.pt.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.pt.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.pt.php', 'D:\\Covoituni_web-master\\vendor\\vich\\uploader-bundle/translations\\messages.pt.yaml'], 'pt_BR' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.pt_BR.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.pt_BR.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.pt_BR.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.pt_BR.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.pt_BR.xliff'], 'ro' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.ro.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.ro.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.ro.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.ro.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.ro.xliff'], 'ru' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.ru.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.ru.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.ru.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.ru.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.ru.xliff', 'D:\\Covoituni_web-master\\vendor\\vich\\uploader-bundle/translations\\messages.ru.yaml'], 'sk' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.sk.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.sk.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.sk.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.sk.php'], 'sl' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.sl.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.sl.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.sl.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.sl.php', 'D:\\Covoituni_web-master\\vendor\\vich\\uploader-bundle/translations\\messages.sl.yaml'], 'sq' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.sq.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.sq.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.sq.xlf'], 'sr_Cyrl' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Cyrl.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.sr_Cyrl.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Cyrl.xlf'], 'sr_Latn' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Latn.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.sr_Latn.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Latn.xlf'], 'sv' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.sv.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.sv.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.sv.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.sv.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.sv.xliff'], 'th' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.th.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.th.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.th.xlf'], 'tl' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.tl.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.tl.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.tl.xlf'], 'tr' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.tr.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.tr.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.tr.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.tr.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.tr.xliff', 'D:\\Covoituni_web-master\\vendor\\vich\\uploader-bundle/translations\\messages.tr.yaml'], 'uk' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.uk.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.uk.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.uk.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.uk.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.uk.xliff', 'D:\\Covoituni_web-master\\vendor\\vich\\uploader-bundle/translations\\messages.uk.yaml'], 'ur' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.ur.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.ur.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.ur.xlf'], 'uz' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.uz.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.uz.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.uz.xlf'], 'vi' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.vi.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.vi.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.vi.xlf'], 'zh_CN' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.zh_CN.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.zh_CN.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.zh_CN.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.zh_CN.php', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.zh_CN.xliff'], 'zh_TW' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations\\validators.zh_TW.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations\\validators.zh_TW.xlf', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations\\security.zh_TW.xlf', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.zh_TW.php'], 'sr_RS' => ['D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations\\EasyAdminBundle.sr_RS.php'], 'ky' => ['D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.ky.xliff'], 'sw' => ['D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations\\KnpPaginatorBundle.sw.xliff'], 'vn' => ['D:\\Covoituni_web-master\\vendor\\vich\\uploader-bundle/translations\\messages.vn.yaml']], 'scanned_directories' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations', 'D:\\Covoituni_web-master\\vendor\\vich\\uploader-bundle/translations', 'D:\\Covoituni_web-master/translations', 'D:\\Covoituni_web-master\\vendor\\symfony\\framework-bundle/translations', 'D:\\Covoituni_web-master\\vendor\\doctrine\\doctrine-bundle/translations', 'D:\\Covoituni_web-master\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 'D:\\Covoituni_web-master\\vendor\\symfony\\debug-bundle/translations', 'D:\\Covoituni_web-master\\vendor\\symfony\\twig-bundle/translations', 'D:\\Covoituni_web-master\\vendor\\symfony\\web-profiler-bundle/translations', 'D:\\Covoituni_web-master\\vendor\\symfony\\stimulus-bundle/translations', 'D:\\Covoituni_web-master\\vendor\\symfony\\ux-turbo/translations', 'D:\\Covoituni_web-master\\vendor\\twig\\extra-bundle/translations', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-bundle/translations', 'D:\\Covoituni_web-master\\vendor\\symfony\\monolog-bundle/translations', 'D:\\Covoituni_web-master\\vendor\\symfony\\maker-bundle/translations', 'D:\\Covoituni_web-master\\vendor\\symfony\\ux-twig-component/translations', 'D:\\Covoituni_web-master\\vendor\\stof\\doctrine-extensions-bundle\\src/translations', 'D:\\Covoituni_web-master\\vendor\\karser\\karser-recaptcha3-bundle/translations'], 'cache_vary' => ['scanned_directories' => ['D:\\Covoituni_web-master\\vendor\\symfony\\validator/Resources/translations', 'D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/translations', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-core/Resources/translations', 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/translations', 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/translations', 'D:\\Covoituni_web-master\\vendor\\vich\\uploader-bundle/translations', 'translations', 'D:\\Covoituni_web-master\\vendor\\symfony\\framework-bundle/translations', 'D:\\Covoituni_web-master\\vendor\\doctrine\\doctrine-bundle/translations', 'D:\\Covoituni_web-master\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 'D:\\Covoituni_web-master\\vendor\\symfony\\debug-bundle/translations', 'D:\\Covoituni_web-master\\vendor\\symfony\\twig-bundle/translations', 'D:\\Covoituni_web-master\\vendor\\symfony\\web-profiler-bundle/translations', 'D:\\Covoituni_web-master\\vendor\\symfony\\stimulus-bundle/translations', 'D:\\Covoituni_web-master\\vendor\\symfony\\ux-turbo/translations', 'D:\\Covoituni_web-master\\vendor\\twig\\extra-bundle/translations', 'D:\\Covoituni_web-master\\vendor\\symfony\\security-bundle/translations', 'D:\\Covoituni_web-master\\vendor\\symfony\\monolog-bundle/translations', 'D:\\Covoituni_web-master\\vendor\\symfony\\maker-bundle/translations', 'D:\\Covoituni_web-master\\vendor\\symfony\\ux-twig-component/translations', 'D:\\Covoituni_web-master\\vendor\\stof\\doctrine-extensions-bundle\\src/translations', 'D:\\Covoituni_web-master\\vendor\\karser\\karser-recaptcha3-bundle/translations']]], []);
    ...
    protected static function getTwigService($container)
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\WebProfilerBundle\Profiler\CodeExtension($g, 'D:\\Covoituni_web-master', 'UTF-8'));
    ...
    {
        $container->privates['twig.loader.native_filesystem'] = $instance = new \Twig\Loader\FilesystemLoader([], 'D:\\Covoituni_web-master');

        $instance->addPath('D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle\\src/../templates/', 'ea');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\doctrine\\doctrine-bundle/templates', 'Doctrine');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\doctrine\\doctrine-bundle/templates', '!Doctrine');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\doctrine\\doctrine-migrations-bundle/templates', 'DoctrineMigrations');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\doctrine\\doctrine-migrations-bundle/templates', '!DoctrineMigrations');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\symfony\\debug-bundle/Resources/views', 'Debug');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\symfony\\debug-bundle/Resources/views', '!Debug');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\symfony\\web-profiler-bundle/Resources/views', 'WebProfiler');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\symfony\\web-profiler-bundle/Resources/views', '!WebProfiler');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\symfony\\ux-turbo/templates', 'Turbo');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\symfony\\ux-turbo/templates', '!Turbo');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\symfony\\maker-bundle/templates', 'Maker');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\symfony\\maker-bundle/templates', '!Maker');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\symfony\\ux-twig-component/templates', 'TwigComponent');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\symfony\\ux-twig-component/templates', '!TwigComponent');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/templates', 'EasyAdmin');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle/templates', '!EasyAdmin');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/templates', 'KnpPaginator');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle/templates', '!KnpPaginator');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\vich\\uploader-bundle/templates', 'VichUploader');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\vich\\uploader-bundle/templates', '!VichUploader');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\karser\\karser-recaptcha3-bundle/Resources/views', 'KarserRecaptcha3');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\karser\\karser-recaptcha3-bundle/Resources/views', '!KarserRecaptcha3');
        $instance->addPath('D:\\Covoituni_web-master/templates');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\symfony\\twig-bridge/Resources/views/Email', 'email');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\symfony\\twig-bridge/Resources/views/Email', '!email');
        $instance->addPath('D:\\Covoituni_web-master\\vendor\\symfony\\twig-bridge/Resources/views/Form');
    ...
    protected static function getValidator_BuilderService($container)
    {
        ...
        $instance->addXmlMappings(['D:\\Covoituni_web-master\\vendor\\symfony\\form/Resources/config/validation.xml']);
    ...
    {
        return [
            'kernel.project_dir' => 'D:\\Covoituni_web-master',
            ...
            'kernel.bundles_metadata' => [
                'FrameworkBundle' => [
                    'path' => 'D:\\Covoituni_web-master\\vendor\\symfony\\framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ],
                'DoctrineBundle' => [
                    'path' => 'D:\\Covoituni_web-master\\vendor\\doctrine\\doctrine-bundle',
                    'namespace' => 'Doctrine\\Bundle\\DoctrineBundle',
                ],
                'DoctrineMigrationsBundle' => [
                    'path' => 'D:\\Covoituni_web-master\\vendor\\doctrine\\doctrine-migrations-bundle',
                    'namespace' => 'Doctrine\\Bundle\\MigrationsBundle',
                ],
                'DebugBundle' => [
                    'path' => 'D:\\Covoituni_web-master\\vendor\\symfony\\debug-bundle',
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ],
                'TwigBundle' => [
                    'path' => 'D:\\Covoituni_web-master\\vendor\\symfony\\twig-bundle',
                    'namespace' => 'Symfony\\Bundle\\TwigBundle',
                ],
                'WebProfilerBundle' => [
                    'path' => 'D:\\Covoituni_web-master\\vendor\\symfony\\web-profiler-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebProfilerBundle',
                ],
                'StimulusBundle' => [
                    'path' => 'D:\\Covoituni_web-master\\vendor\\symfony\\stimulus-bundle',
                    'namespace' => 'Symfony\\UX\\StimulusBundle',
                ],
                'TurboBundle' => [
                    'path' => 'D:\\Covoituni_web-master\\vendor\\symfony\\ux-turbo',
                    'namespace' => 'Symfony\\UX\\Turbo',
                ],
                'TwigExtraBundle' => [
                    'path' => 'D:\\Covoituni_web-master\\vendor\\twig\\extra-bundle',
                    'namespace' => 'Twig\\Extra\\TwigExtraBundle',
                ],
                'SecurityBundle' => [
                    'path' => 'D:\\Covoituni_web-master\\vendor\\symfony\\security-bundle',
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ],
                'MonologBundle' => [
                    'path' => 'D:\\Covoituni_web-master\\vendor\\symfony\\monolog-bundle',
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ],
                'MakerBundle' => [
                    'path' => 'D:\\Covoituni_web-master\\vendor\\symfony\\maker-bundle',
                    'namespace' => 'Symfony\\Bundle\\MakerBundle',
                ],
                'TwigComponentBundle' => [
                    'path' => 'D:\\Covoituni_web-master\\vendor\\symfony\\ux-twig-component',
                    'namespace' => 'Symfony\\UX\\TwigComponent',
                ],
                'EasyAdminBundle' => [
                    'path' => 'D:\\Covoituni_web-master\\vendor\\easycorp\\easyadmin-bundle',
                    'namespace' => 'EasyCorp\\Bundle\\EasyAdminBundle',
                ],
                'KnpPaginatorBundle' => [
                    'path' => 'D:\\Covoituni_web-master\\vendor\\knplabs\\knp-paginator-bundle',
                    'namespace' => 'Knp\\Bundle\\PaginatorBundle',
                ],
                'VichUploaderBundle' => [
                    'path' => 'D:\\Covoituni_web-master\\vendor\\vich\\uploader-bundle',
                    'namespace' => 'Vich\\UploaderBundle',
                ],
                'StofDoctrineExtensionsBundle' => [
                    'path' => 'D:\\Covoituni_web-master\\vendor\\stof\\doctrine-extensions-bundle\\src',
                    'namespace' => 'Stof\\DoctrineExtensionsBundle',
                ],
                'KarserRecaptcha3Bundle' => [
                    'path' => 'D:\\Covoituni_web-master\\vendor\\karser\\karser-recaptcha3-bundle',
            ...
            'translator.default_path' => 'D:\\Covoituni_web-master/translations',
            ...
            'twig.default_path' => 'D:\\Covoituni_web-master/templates',
