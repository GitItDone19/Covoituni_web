...
/* passager/liste_trajet.html.twig */
class __TwigTemplate_76a290f2a296907b7b82a8841e667f7e extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "passager/liste_trajet.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "passager/liste_trajet.html.twig"));

        $this->parent = $this->loadTemplate("layouts/user_layout.html.twig", "passager/liste_trajet.html.twig", 1);
    ...
    public function block_title(array $context, array $blocks = []): iterable
    {
        ...
        yield "Liste des Trajets - Passager";
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        <div class=\"glass-card bg-white/90 backdrop-blur-sm border border-white/30 rounded-xl shadow-xl p-8 mb-8\">
            <div class=\"flex justify-between items-center mb-6\">
                <div>
                    <h1 class=\"text-3xl font-bold mb-2 text-gray-800\">Liste des trajets disponibles</h1>
                    <p class=\"text-gray-600\">Consultez les trajets disponibles et trouvez votre prochain covoiturage.</p>
                </div>
            </div>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
            // line 16
            yield "                <div class=\"mb-4 p-4 bg-green-100 border border-green-400 text-green-700 rounded-xl\">
                    ";
            // line 17
        ...
        if (Twig\Extension\CoreExtension::testEmpty((isset($context["trajets"]) || array_key_exists("trajets", $context) ? $context["trajets"] : (function () { throw new RuntimeError('Variable "trajets" does not exist.', 42, $this->source); })()))) {
            ...
            yield "                    <div class=\"bg-gray-50 rounded-xl p-8 text-center\">
                        ...
                        <p class=\"mt-2 text-gray-600\">Aucun trajet n'est disponible pour le moment.</p>
                        <a href=\"";
            // line 49
            yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_passager_ajouter_trajet");
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["trajet"]) {
                ...
                yield "\" 
                                           class=\"inline-flex items-center px-3 py-1.5 bg-blue-100 text-blue-800 text-xs font-medium rounded-lg hover:bg-blue-200 transition-colors duration-300\">
...
";
    ...
    {
        return "passager/liste_trajet.html.twig";
    }
    ...
    {
        return array (  341 => 156,  328 => 155,  288 => 124,  277 => 115,  260 => 104,  250 => 97,  242 => 92,  232 => 85,  225 => 81,  208 => 67,  204 => 66,  197 => 62,  193 => 61,  189 => 60,  185 => 59,  181 => 58,  178 => 57,  174 => 56,  171 => 55,  162 => 49,  154 => 43,  152 => 42,  128 => 20,  119 => 17,  116 => 16,  112 => 15,  101 => 6,  88 => 5,  65 => 3,  42 => 1,);
    }
...
{% block title %}Liste des Trajets - Passager{% endblock %}
            ...
            <div class=\"mb-6\">
                ...
                {% if trajets is empty %}
                    <div class=\"bg-gray-50 rounded-xl p-8 text-center\">
                        ...
                        <h3 class=\"mt-4 text-xl font-medium text-gray-900\">Aucun trajet trouvé</h3>
                        <p class=\"mt-2 text-gray-600\">Aucun trajet n'est disponible pour le moment.</p>
                        <a href=\"{{ path('app_passager_ajouter_trajet') }}\" class=\"mt-4 inline-flex items-center px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary-dark transition duration-300\">
                            <i class=\"fas fa-plus mr-2\"></i>
                            Créer un nouveau trajet
                        </a>
                    </div>
                        ...
                        {% for trajet in trajets %}
                            <div class=\"trajet-card bg-white rounded-xl shadow-md overflow-hidden\"
                                ...
                                <div class=\"p-6\">
                                    ...
                                    <div class=\"mt-4 flex justify-end gap-2\">
                                        <a href=\"{{ path('app_map_trajet', {'id': trajet.id}) }}\" 
                                           class=\"inline-flex items-center px-3 py-1.5 bg-blue-100 text-blue-800 text-xs font-medium rounded-lg hover:bg-blue-200 transition-colors duration-300\">
                                            <svg xmlns=\"http://www.w3.org/2000/svg\" class=\"h-4 w-4 mr-1\" fill=\"none\" viewBox=\"0 0 24 24\" stroke=\"currentColor\">
                                                <path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7\" />
                                            </svg>
                                        ...
                                        <a href=\"{{ path('app_passager_liste_annonce') }}\" 
                                           class=\"inline-flex items-center px-3 py-1.5 bg-green-100 text-green-800 text-xs font-medium rounded-lg hover:bg-green-200 transition-colors duration-300\">
                                            <svg xmlns=\"http://www.w3.org/2000/svg\" class=\"h-4 w-4 mr-1\" fill=\"none\" viewBox=\"0 0 24 24\" stroke=\"currentColor\">
                                                <path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z\" />
                                            </svg>
...
{% endblock %} ", "passager/liste_trajet.html.twig", "C:\\Users\\Negza\\Desktop\\Project-PI-SYNFONY\\COPIES-1\\Covoituni_web-main2\\templates\\passager\\liste_trajet.html.twig");
    }
}
