 ...
 */
class getChatMessageRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ChatMessageRepository.php';

        return $container->privates['App\\Repository\\ChatMessageRepository'] = new \App\Repository\ChatMessageRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
