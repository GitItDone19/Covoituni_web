            ...
            foreach ($context['_seq'] as $context["_key"] => $context["trajet"]) {
                ...
                yield " DT</span>
                                    ...
                                    <div class=\"mt-4 flex justify-end gap-2\">
                                        <a href=\"";
                // line 97
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_conducteur_trajet_map", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["trajet"], "id", [], "any", false, false, false, 97)]), "html", null, true);
                        ...
                        {% for trajet in trajets %}
                            <div class=\"trajet-card bg-white rounded-xl shadow-md overflow-hidden\" 
                                ...
                                <div class=\"p-6\">
                                    ...
                                    <div class=\"mt-4 flex justify-end gap-2\">
                                        <a href=\"{{ path('app_conducteur_trajet_map', {'id': trajet.id}) }}\" class=\"inline-flex items-center px-3 py-1.5 bg-blue-100 text-blue-800 text-xs font-medium rounded-lg hover:bg-blue-200 transition-colors duration-300\">
                                            <svg xmlns=\"http://www.w3.org/2000/svg\" class=\"h-4 w-4 mr-1\" fill=\"none\" viewBox=\"0 0 24 24\" stroke=\"currentColor\">
                                                <path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7\" />
                                            </svg>
                                            Carte
