 ...
 */
class getAnnonceEventRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AnnonceEventRepository' shared autowired service.
     *
     * @return \App\Repository\AnnonceEventRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AnnonceEventRepository.php';

        return $container->privates['App\\Repository\\AnnonceEventRepository'] = new \App\Repository\AnnonceEventRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
