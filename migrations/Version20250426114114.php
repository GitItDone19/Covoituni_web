 ...
 */
final class Version20250426114114 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reponse (id INT AUTO_INCREMENT NOT NULL, reclamation_id INT NOT NULL, content LONGTEXT NOT NULL, date DATETIME NOT NULL, admin_username VARCHAR(255) NOT NULL, INDEX IDX_5FB6DEC72D6BA2D9 (reclamation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE reclamation DROP reply, CHANGE status status VARCHAR(20) DEFAULT \'pending\' NOT NULL, CHANGE date date DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamation ADD reply LONGTEXT DEFAULT NULL, CHANGE status status VARCHAR(50) DEFAULT \'pending\' NOT NULL, CHANGE date date DATE NOT NULL');
