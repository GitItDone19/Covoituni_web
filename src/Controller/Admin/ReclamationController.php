...
class ReclamationController extends AbstractController
{
    ...
    /**
     * Export reclamations to CSV format
     */
    #[Route('/export/csv', name: 'app_admin_reclamation_export_csv', methods: ['GET'])]
    public function exportCsv(ReclamationRepository $reclamationRepository): Response
    {
        // Make sure only users with ROLE_ADMIN can access this page
        $this->denyAccessUnlessGranted('ROLE_ADMIN');
