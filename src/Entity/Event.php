...
class Event
{
    ...
    #[Assert\GreaterThanOrEqual(
        value: "today",
        message: "La date de l'événement doit être égale ou postérieure à aujourd'hui."
    )]
    private ?\DateTimeInterface $dateEvent = null;

    #[ORM\Column(name: 'heure_event', type: Types::TIME_MUTABLE)]
    #[Assert\NotNull(message: "L'heure de l'événement est obligatoire.")]
    ...
    #[Assert\Length(
        min: 2,
        max: 255,
        minMessage: "Le lieu de l'événement doit comporter au moins {{ limit }} caractères.",
